...
const StandingTableRow = (props) => {
  return (
    ...
    <View style={{width:"100%",borderBottomWidth:.5, borderBottomColor:colors.gray,paddingVertical:10,paddingHorizontal:3, flexDirection:"row", justifyContent:"space-between",}}>
      ...
      <View style={{flex:3, flexDirection:"row"}}><Image style={{width:"30%", height:20}} source={require("../../../assets/bd-flag.png")}/><Text style={{marginLeft:5, textAlign:"center",fontWeight:"bold", opacity:.5}}>BAN</Text></View>
